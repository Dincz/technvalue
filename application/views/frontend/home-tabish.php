            ...
            <div class="hero-inner">
                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <div class="hero-btns">
                            <a href="#" id="quoteBtn"
                             class="vs-btn style7">Get In Touch</a>
        ...
        <div class="card-body">
            ...
            <?php if (!empty($whats_new)): ?>
                <?php foreach ($whats_new as $new_item): ?>
                    <img src="<?php echo base_url('uploads/services/' . $new_item['w_image']); ?>" alt="<?php echo $new_item['w_title']; ?>" class="img-fluid mb-3 w-100">
            ...
            <div class="col-md-4 col-12 mb-4 home ">
                <div class="tab d-flex text-center">
                    <div class="tablinks col-6 py-2 text-dark fw-medium" onclick="openTab(event, 'aimilShows')">Jobs</div>
                    <div class="tablinks col-6 py-2 text-dark fw-medium" onclick="openTab(event, 'seminarTrainings')">Seminar / Trainings
                    </div>
                </div>
            ...
            <?php foreach ($client as $clients): ?>
                <?php if ($clients['status'] == 1): // Check if the (client) is active ?>
                    <div class="vs-brand1 mx-5">
                        ...
                        <img src="<?php echo base_url('assets/img/brand/' . $clients['image']); ?>" alt="Client Logo">
                    </div>
                <?php endif; ?>
            <?php endforeach; ?>
        <?php else: ?>
            ...
            <div class="col-xl-3">
                <div class="project-style2">
                    <div class="project-img rounded">
                        <img src=<?php echo base_url('assets/img/gallery/' . $item['background_image']); ?> alt="project">
                    ...
                    <div class="project-content rounded">
                        ...
                        <h3 class="project-title h5"><a href="<?php echo base_url($item['see_more_link']); ?>" class="text-reset">See More</a></h3>
                    </div>
                </div>
            </div>
            <?php endforeach; ?> 
