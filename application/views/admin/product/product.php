                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/product/add" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input name="p_name" type="text" class="form-control editModalTitle" placeholder="Enter Product Name" required>
                            </div>
                                ...
                                <select name="c_id" id="category" class="form-control" required>
                                    ...
                                    <?php if (!empty($categories)): ?>
                                        <?php foreach ($categories as $category1): ?>
                                            <option value="<?php echo htmlspecialchars($category1['c_id'], ENT_QUOTES, 'UTF-8'); ?>"
                                                <?php if (isset($row) && $category1['c_id'] == $row['c_id']) echo 'selected'; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <input name="description" type="text" class="form-control editModalTitle" placeholder="Enter Product Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input name="application" type="text" class="form-control editModalTitle" placeholder="Enter Product Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input name="video_link" type="text" class="form-control" placeholder="Enter Video Link">
                            </div>

                            <!-- Submit Button -->
                            <div class="form-group">
                                <button name="submit" type="submit" class="btn btn-primary btn-block mt-3">Create</button>
                            </div>
                        </form>
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Product Name </th>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Product Image </th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> Description</th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> Application</th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> Brand</th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> PDF</th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> Feature</th>
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 94.2344px;"> Video Link</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?php echo htmlspecialchars($row['p_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                                                ...
                                                <td>
                                                    <?php echo htmlspecialchars($row['application'], ENT_QUOTES, 'UTF-8'); ?>
                                                </td>

                                                <td>
                                                    <img src="<?php echo base_url('uploads/Brand/' . $row['brand']); ?>" class="img-fluid" alt="Brand Image">
                                                </td>

                                                <td>
                                                    <a href="<?php echo base_url('uploads/Docs/' . $row['pdf']); ?>" target="_blank">Download PDF</a>
                                                </td>

                                                <td>
                                                    <?php echo htmlspecialchars($row['features'], ENT_QUOTES, 'UTF-8'); ?>
                                                </td>

                                                <td>
                                                    <?php echo htmlspecialchars($row['video_link'], ENT_QUOTES, 'UTF-8'); ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/product/edit/<?php echo $row['p_id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="<?php echo base_url() ?>admin/product/delete/<?php echo $row['p_id']; ?>" class="btn btn-danger shadow btn-xs sharp deletebtn">
